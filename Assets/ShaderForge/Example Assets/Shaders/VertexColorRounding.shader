    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float, _Divisions)
...
////// Lighting:
////// Emissive:
                float _Divisions_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Divisions );
                float node_137 = lerp(0.5,12,pow(_Divisions_var,2.0));
